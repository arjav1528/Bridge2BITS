      ...
      <div className="min-h-screen flex items-center justify-center bg-black">
        ...
        >
          <motion.div
            ...
            className="w-16 h-16 bg-yellow-900 rounded-full flex items-center justify-center mx-auto mb-4"
          >
          ...
          >
            <div className="flex justify-center mb-6">
              ...
              >
                ...
                <motion.div
                  className="absolute -bottom-2 -right-2 w-8 h-8 bg-yellow-900 rounded-full flex items-center justify-center border-4 border-black"
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                >
                  <div className="flex items-center">
                    <motion.div 
                      className="flex-shrink-0 h-10 w-10 rounded-full bg-yellow-100 flex items-center justify-center"
